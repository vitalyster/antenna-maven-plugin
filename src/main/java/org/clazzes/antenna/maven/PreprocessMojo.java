/***********************************************************
 * $Id: PreprocessMojo.java 903 2013-10-04 16:01:28Z util $
 * 
 * org.clazzes Utils
...
/**
 * A MOJO, that executes the antenna preprocessor on the source path of a project configuration.
 *
 * @goal preprocess
 */
public class PreprocessMojo extends AbstractMojo {
    ...
    /**
     * The directory where to put the generated java source files to.
     * This path is added of the project's source directories, so
     * the path must not contain the package subapths'. 
     * @required
     * @parameter default-value="${project.build.directory}/preprocessed-sources"
     */
    private File outputDirectory;

    /**
     * A list of additional source directories to preprocess. This avoids the usage
    ...
    /**
     * The debuglevel value for the preprocessor. 
     * 
     * @parameter
     */
	...
	public void execute() throws MojoExecutionException, MojoFailureException {
		...
		List<String> srcDirs = this.project.getCompileSourceRoots();
		...
		pp.setDebugLevel(this.debugLevel);

		if (this.additionalSources != null) {
			
			srcDirs.addAll(this.additionalSources);
		}
